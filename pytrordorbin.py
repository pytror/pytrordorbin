#######################################
# Run By ===> Python ( Python3 )
# Coded By ===> LUCIFER
# Telegram Channel ===> T.me/p@ytror
#######################################
...
try:
    ...
    print("\033[1;37m💻hacker💻")
    print("\033[1;37m      💻pytror💻ساخته شده توسط  ")
    print("\033[1;37m   The End  ")
    exit()